...
#define KC_SPTLHT  LGUI(KC_SPACE)
#define KC_FW      LGUI(KC_RBRC)
#define KC_BK      LGUI(KC_LBRC)
#define KC_S_FW    LGUI(KC_RCBR)
#define KC_S_BK    LGUI(KC_LCBR)
#define KC_CTLUP   LCTL(KC_UP)
#define KC_CTLDW   LCTL(KC_DOWN)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      _____, _____, _____, _____, _____, _____,                   CTLL, CTLDW, CTLUP,  CTLR, _____, _____,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                  _____, _____,   SPC,    _____,ADJUST,_____ \
                              //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                  _____,ADJUST,   SPC,    _____, _____, _____ \
                              //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      _____, _____,    BK,  WH_D,  WH_U,    FW,                  XXXXX,  MS_L,  MS_D,  MS_R, _____,  ACL1,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      _____, _____,  S_BK, _____, _____,  S_FW,                 SPTLHT, _____, _____, _____, _____,  ACL2,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
